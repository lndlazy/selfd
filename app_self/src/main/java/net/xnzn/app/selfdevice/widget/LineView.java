...
public class LineView extends View {
  ...
  private final int popupTopPadding = DensityUtil.dip2px(getContext(), 2);
  private final int popupBottomMargin = DensityUtil.dip2px(getContext(), 5);
  private final int bottomTextTopMargin = DensityUtil.sp2px(getContext(), 5);
  private final int bottomLineLength = DensityUtil.sp2px(getContext(), 22);
  private final int DOT_INNER_CIR_RADIUS = DensityUtil.dip2px(getContext(), 2);
  private final int DOT_OUTER_CIR_RADIUS = DensityUtil.dip2px(getContext(), 5);
  private final int MIN_TOP_LINE_LENGTH = DensityUtil.dip2px(getContext(), 12);
  ...
  private int popupBottomPadding = DensityUtil.dip2px(getContext(), 2);
  /*
        |  | ←topLineLength
      --+--+--+--+--+--+--
      --+--+--+--+--+--+--
       ↑sideLineLength
   */
  private int topLineLength = DensityUtil.dip2px(getContext(), 12);
  private int sideLineLength = DensityUtil.dip2px(getContext(), 45) / 3 * 2;

  private int backgroundGridWidth = DensityUtil.dip2px(getContext(), 45);
  ...
  private void drawPopup(Canvas canvas, float num, Point point, int PopupColor) {
    ...
    int sidePadding = DensityUtil.dip2px(getContext(), singularNum ? 8 : 5);
    int x = point.x;
  ...
  class Dot {
    ...
    float targetY;
    int linenumber;
    int velocity = DensityUtil.dip2px(getContext(), 18);
